/// A job posting row in the administrator's moderation view.
///
/// Mirrors the backend `JobPostingResponse` shape used by `GET /JobPostings`.
class AdminJobPostingModel {
  const AdminJobPostingModel({
    required this.id,
    required this.title,
  ...
  factory AdminJobPostingModel.fromJson(Map<String, dynamic> json) {
    return AdminJobPostingModel(
      id: json['id'] as int? ?? 0,
