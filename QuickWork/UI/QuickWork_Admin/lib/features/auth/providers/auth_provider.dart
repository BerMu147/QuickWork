...
/// Holds authentication state for the administrator console.
///
/// Only users holding the `Administrator` role may use the console. On
/// successful login the JWT token and user are persisted locally, so the
...
class AuthProvider extends ChangeNotifier {
  ...
  /// Whether the signed-in user holds the administrator role.
  bool get isAdministrator =>
      _user != null && _user!.hasRole('Administrator');
